...
public class FollowController : ControllerBase
{
    ...
    // 1. TAKİP ET SERVİSİ
    // POST: api/follow/5/follow/10 (5 ID'li kullanıcı, 10 ID'li kullanıcıyı takip eder)
    ...
    // DELETE: api/follow/5/unfollow/10
    ...
    // GET: api/follow/search?keyword=ahmet
    [HttpGet("search")]
    public async Task<IActionResult> SearchUsers([FromQuery] string keyword)
    {
        ...
        // Eşref'in User modelindeki Email alanına göre arama yapıyoruz
